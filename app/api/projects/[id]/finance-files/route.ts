...
export async function GET(
  ...
  try {
    ...
    if (error) {
      console.error('[GET /api/projects/[id]/finance-files]', error.message)
...
export async function POST(
  ...
  try {
    ...
    const storagePath = `finance/${id}/${file.name}`
    ...
    if (uploadError) {
      console.error('[POST /api/projects/[id]/finance-files] upload error:', uploadError.message)
